...
#ifndef SFE_BMP180_H_
#define SFE_BMP180_H_
...
class SFE_BMP180
{
	public:
		...
		SFE_BMP180(TWI_Master_t *mytwi,int address); // base type
		...
		double measure_pressure(double sealevel);
...
#define BMP180_SLAVE_ADDR 0x77 // 7-bit address
